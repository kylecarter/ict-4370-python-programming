...
from carterk_assignment5_bond import Bond
...
class Owner():
    ...
    def print_stock_details(self):
        ...
        spaces = ''.join([' ' for x in range(0, len(headings))])
        header = [heading.upper() + spaces for heading in headings]
        divider = ''.join(
